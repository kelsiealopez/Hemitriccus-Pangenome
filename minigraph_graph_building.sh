#!/bin/bash
#SBATCH -p edwards,shared,test
#SBATCH -c 20
#SBATCH -t 0-12:00
#SBATCH -o minigraph_%j.out
#SBATCH -e minigraph_%j.err 
#SBATCH --mem=100000
...
analysis_path="/n/holyscratch01/edwards_lab/Users/kelsielopez/minigraph_redo"


ref="HemMar_out_JBAT.FINAL_renamed_sorted"
